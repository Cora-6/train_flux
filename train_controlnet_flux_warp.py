...
def log_validation(
    ...
    if not is_final_validation:
        ...
        flux_controlnet = WarpAndFluxControlNetModel.from_pretrained(
...
def main(args):
    ...
    if args.controlnet_model_name_or_path:
        ...
        flux_controlnet = WarpAndFluxControlNetModel.from_transformer(
            flux_transformer,
    ...
    if version.parse(accelerate.__version__) >= version.parse("0.16.0"):
        ...
        def load_model_hook(models, input_dir):
            while len(models) > 0:
                ...
                load_model = WarpAndFluxControlNetModel.from_pretrained(input_dir, subfolder="flux_controlnet")
